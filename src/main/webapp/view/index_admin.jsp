...
<body class="" style="">
			...
			<div class="flex-grow-1">
				...
				<main class="_layout-main_jqb0o_4">
					<div class="_main-contents-background_jqb0o_10">
						<div class="_main-contents_jqb0o_10">
							<section class="_container_19xms_7">
								<h2 class="_title_19xms_13 t-p-h2-bold">대시보드</h2>
								...
								<div class="_chart_19xms_80">
									<div class="_chart-wrapper_1p5th_7">
										<div>
											<div class="_chart-title-wrapper_1p5th_44">
												<h4 class="_chart-title_1p5th_44">예약 통계</h4>
											</div>
											<div class="_chart-unit-wrapper_1p5th_11">
												<button
													class="_button_11kek_7 _height--40_11kek_43 _font--pretendard_11kek_28  _height--40_scibe_11 _variant--secondary_scibe_27  "
													aria-selected="true">
													<span class="_content_scibe_51 ">일간</span>
												</button>
												<button
													class="_button_11kek_7 _height--40_11kek_43 _font--pretendard_11kek_28  _height--40_scibe_11 _variant--secondary_scibe_27  "
													aria-selected="false">
													<span class="_content_scibe_51 ">월간</span>
												</button>
												
											</div>
										</div>
										<div
											class="flex flex-col w-full h-[350px] t-p-b2-regular color-gray11">
											<div class="flex flex-1 mb-4px">
												...
												<div
													class="flex flex-col flex-1 min-w-0 overflow-x-auto overflow-y-visible">
													...
													<div class="border-t border-t-gray3"
														style="min-width: 618.663px; padding: 0px;">
														<div class="relative z-element">
															<div class="z-element flex flex-col min-w-fit py-12px"
																style="width: 618.663px;">
																<div
																	class="flex text-center justify-evenly whitespace-nowrap min-w-fit"
																	style="justify-content: space-between; padding-left: 0px;">
																	<div class="flex justify-start"
																		style="min-width: 88.3804px; max-width: 88.3804px;">
																		<div
																...
																<div
																	...
																	style="justify-content: space-between; padding-left: 0px;">
																	<div class="flex justify-start"
																		style="min-width: 618.663px; max-width: 618.663px;">
																		<div
																			class="t-p-caption-regular text-gray-8 flex justify-center sticky left-0"
																			style="width: 88.3804px; z-index: 6;">
																			<span class="px-3"
																				style="background: linear-gradient(90deg, rgba(255, 255, 255, 0) 0%, rgb(255, 255, 255) 12px);">5월</span>
																		</div>
																	</div>
																</div>
															</div>
											...
											<div
												class="flex flex-wrap justify-center gap-20px t-p-b2-regular"
												style="color: rgb(38, 38, 38);">
												<div
													class="inline-flex items-center gap-7px leading-17px whitespace-nowrap min-w-fit">
													<div class="w-12px border-t-1 border-b-0"
														style="border-color: rgb(252, 107, 45);"></div>
													<span class="keep-all">예약자 수</span>
												</div>
											</div>
										</div>
									</div>
									<div class="_chart-wrapper_13n2s_7">
										<div class="_chart-title-wrapper_13n2s_14">
											<h4 class="_chart-title_13n2s_14">투어 코스별 순예약 TOP5</h4>
										</div>
										<div class="flex flex-col mt-10 pt-18px h-265px">
	...
	<div
		...
		aria-hidden="true"
		style="position: absolute; top: 299.6px; left: 934.263px;">
		<h1 class="_tooltipTitle_1ezz8_35 _unit-tooltip-title_1p5th_133">그래프
			단위</h1>
		<span class="_tooltipText_1ezz8_55 _unit-tooltip-content_1p5th_136">1개월
			이하: 일, 시간<br> 1개월 초과: 주, 일<br>6개월 초과: 달, 주
		</span>
	</div>
</body>
</html>
