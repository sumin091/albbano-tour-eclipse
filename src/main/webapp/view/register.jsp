...
<section id="sub_wrapper">
    ...
    <div class="scontents">
        ...
        <div class="register">
            ...
            <form name="fregister" id="fregister" action="join.jsp"
                  onsubmit="return fregister_submit(this);" method="POST" autocomplete="off">

                <p><i class="fa fa-check-circle" aria-hidden="true"></i> 회원가입약관 및 개인정보처리방침안내의 내용에 동의하셔야 회원가입 하실 수 있습니다.
                </p>

                <section id="fregister_term">
                    <h2>회원가입약관</h2>
                    <textarea readonly>제1조(목적)
					이 이용약관(이하 '약관')은 알빠노관광 (http://www.albbano.sist.co.kr) (이하 회사라 합니다)와 이용 고객(이하 '회원')간에 회사가 제공하는 서비스의 가입조건 및 이용에 관한 제반 사항과 기타 필요한 사항을 구체적으로 규정함을 목적으로 합니다.
					제2조(이용약관의 효력 및 변경)
					① 이 약관은 본 회사에 가입된 고객을 포함하여 서비스를 이용하고자 하는 모든 이용자에 대하여 서비스 메뉴 및 회사에 게시하여 공시하거나 기타의 방법으로 고객에게 공지함으로써 그 효력을 발생합니다. 약관의 게시는 알빠노관광 (http://www.albbano.co.kr) 사이트에서 확인 할 수 있습니다.
					...
					제17조(계약 변경 및 해지)
					회원이 이용계약을 해지하고자 하는 때에는 회원 본인이 www.albbano.sist.co.kr 웹 내의 &#034;회원탈퇴&#034;메뉴를 이용해 가입해지를 해야 합니다.
					제18조(서비스 이용제한)
					...
					이 약관은 2013년 06월 11일부터 시행합니다. </textarea>
